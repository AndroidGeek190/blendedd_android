 ...
 */
public class ViewPagerAdapterHomeTabs extends FragmentStatePagerAdapter {
    ...
    public ViewPagerAdapterHomeTabs(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
