...
import com.erginus.blendedd.Transform.CubeOutTransformer;
import com.erginus.blendedd.Transform.ZoomOutPageTransformer;
...
//    ListView listView;
   ...
   // ActionBarDrawerToggle mDrawerToggle;
    ...
    String image, price, city_name, state_code, city_id, postid,tiTle,tile_shadow,  post_desc, post_status, min_price,daily_price,
            weekly_price, monthly_price,day,from,to,pstname, button_id,button_price,button_text,button_value,current_day,current_time;
    EditText edt_search;
    String post_id,cat_title;
...
getdata=new SharedPreference(HomeActivity.this);
        getdata.setdrawer("0");
...
//            if(value.equals("2")){
//                pager.setCurrentItem(Integer.valueOf(value));
//            }
//        }
                ...
                categoryItemListView.setOnLoadMoreListener(new EndlessListView.OnLoadMoreListener() {
                    ...
                    public boolean onLoadMore() {
                        if (mIsLoading) {
                            ...
                            Toast.makeText(HomeActivity.this, "No more data to load",
                                ...
                                if ("1".equals(serverCode)) {
                                    ...
                                    if (arrayday.length() > 0) {
                                        for (int i = 0; i < arrayday.length(); i++) {
                                            ...
                                            dayslist.add(categoryItemModel2(day, from, to,current_day,current_time));
